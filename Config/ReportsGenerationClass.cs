...
namespace ELIT_Selenium_TR.Config
{
    [SetUpFixture]
    public abstract class ReportsGenerationClass
    {
        ...
        public void BeforeTest()
        {
            ...
            options.AddAdditionalCapability("useAutomationExtension", false); // Disabling header which contains 'Chrome is running by Automated Software'
            ...
            _driver = new ChromeDriver(@"C:\Users\ATSTC004\source\repos\JenkinDemo\Driver\", options);  //Location of Chrome Driver.EXE in the project
